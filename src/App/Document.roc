    ...
    Html.html [Attr.lang "en"] [
        Html.head
            ...
            [
                ...
                Html.script [Attr.src "https://unpkg.com/htmx.org@1.9.12/dist/ext/loading-states.js"] [],
                Html.script [Attr.src "https://cdn.jsdelivr.net/npm/swiper@11/swiper-element-bundle.min.js"] [],
                Html.script [Attr.type "module"] [Html.dangerouslyIncludeUnescapedHtml imageElementJs],
                Html.script [Attr.src "https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"] [],
                App.Styles.view,
            ],
        Html.body
            [
